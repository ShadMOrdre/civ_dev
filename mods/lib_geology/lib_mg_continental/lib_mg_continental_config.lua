...
--##
	...
	lib_mg_continental.mg_3d = false
...
--##	(2400 * 0.1) * 0.25 == 240 / 4 == 60
	...
	lib_mg_continental.mg_noise_octaves = 7
	...
	lib_mg_continental.mg_mountain = lib_materials.maxheight_highland
...
--##
	...
	if lib_mg_continental.mg_world_scale < 1 then
		if lib_mg_continental.mg_world_scale >= 0.1 then
			lib_mg_continental.mg_noise_octaves = 6
			lib_mg_continental.mg_noise_persist = 0.5
		else
...
--##
	...
	lib_mg_continental.cellmap = {}
	lib_mg_continental.neighbors = {}
	
	lib_mg_continental.heightmap = {}
	lib_mg_continental.biomemap = {} 
	lib_mg_continental.heatmap = {} 
	lib_mg_continental.humiditymap = {} 
	lib_mg_continental.edgemap = {}
	lib_mg_continental.cliffmap = {}
...
--##
	...
	lib_mg_continental.P["np_3dterrain"] = {
		offset = 0,
		scale = 1,
		spread = {x = (384 * lib_mg_continental.mg_world_scale), y = (192 * lib_mg_continental.mg_world_scale), z = (384 * lib_mg_continental.mg_world_scale)},
		seed = 5934,
		--seed = 5900033,
		octaves = (lib_mg_continental.mg_noise_octaves - 4),
		--octaves = 5,
		persist = 0.3,
		--persist = 0.5,
		lacunarity = 2.19,
	...
	--lib_mg_continental.P["np_3dterrain_mountain"] = {
	--	offset = 0,
	--	scale = 1,
	--	spread = {x = (384 * lib_mg_continental.mg_world_scale), y = (384 * lib_mg_continental.mg_world_scale), z = (384 * lib_mg_continental.mg_world_scale)},
	--	seed = 5934,
	--	--seed = 5900033,
	--	octaves = 5,
	--	persist = 0.5,
